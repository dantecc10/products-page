        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="text-dark mb-4 text-center main-branding-text-color fw-bold">Transacciones</h1>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold main-branding-text-color">Transacciones</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <div class="input-group"><input class="form-control" type="text" placeholder="Buscar transacción" oninput="javascript:search_transaction();" onchange="javascript:search_transaction();"><button class="btn btn-primary main-branding-background-color" type="button"><i class="fas fa-search"></i></button></div>
                                </div>
                            </div>

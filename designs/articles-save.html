      ...
      <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
        <div class="container-fluid d-flex flex-column p-0">
          <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="index.php">
            <div class="sidebar-brand-icon col col-3 d-flex justify-content-center">
              <img class="icon-circle" onchange="javascript:filtroInventario();" src="../assets/img/branding/logo.jpeg">
            </div>
          ...
          <ul class="navbar-nav text-light" id="accordionSidebar">
            <li class="nav-item">
              <a class="nav-link" href="articles.html"><i class="fas fa-table"></i><span>Artículos</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="detail.html"><i class="fas fa-search"></i><span>Detalle producto</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="sale.html"><i class="fas fa-cash-register"></i><span>Vender</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="transactions.html"><i class="fas fa-hand-holding-usd"></i><span>Transacciones</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="tasks.html"><i class="fas fa-tasks"></i><span>Tareas</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="operations.html"><i class="fas fa-hard-hat"></i><span>Operaciones</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="chat.html"><i class="fas fa-comments"></i><span>Chat</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="profile.html"><i class="fas fa-user"></i><span>Perfil</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="logout.html"><i class="fas fa-door-open"></i><span>Cerrar sesión</span></a>
            </li>
          </ul>
          ...
          <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
            <div class="container-fluid">
              <button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button">
                <i class="fas fa-bars main-branding-text-color"></i></button><a href="sale.html" style="width: 100%"><button class="btn btn-primary main-branding-background-color" type="button" style="
                    font-size: 85% !important; /*padding: 12% !important;*/
                    width: 100%;
                  ">
              ...
              <ul class="navbar-nav flex-nowrap ms-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                  <div class="nav-item dropdown no-arrow">
                    <a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small">Dante</span><img class="border rounded-circle img-profile" src="../assets/img/avatars/avatar1.jpeg"></a>
          ...
          <div class="container-fluid">
            ...
            <div class="card shadow">
              <div class="card-header py-3">
                <p class="text-primary m-0 fw-bold main-branding-text-color">
                  Juguetes
                </p>
              </div>
              <div class="card-body">
                  ...
                  <div class="col">
                    <form>
                      <div class="input-group">
                        <input class="form-control" type="text" placeholder="Buscar"><button class="btn btn-primary main-branding-background-color" type="button">
                    ...
                    <tbody id="table-toys" class="articles-table">
                      <tr id="article-row-1" class="align-middle articles-row">
                        <td class="article-icon">
                          <a href="detalle.html"><img class="mini-image" src="https://media.playmobil.com/i/playmobil/71162_product_detail/Polic%C3%ADa%20con%20Perro?locale=es-MX,es,en,*&amp;$pdp_product_main_xs$&amp;fmt=auto&amp;strip=true&amp;qlt=80&amp;fmt.jpeg.chroma=1,1,1&amp;unsharp=0,1,1,7&amp;fmt.jpeg.interlaced=true"></a>
                        </td>
                        <td>
                          <a href="detalle.html"><span style="color: rgb(133, 135, 150)">Producto 2 de prueba para tablita</span><br></a>
                        </td>
                        <td>
                          <a href="detalle.html"><span style="color: rgb(133, 135, 150)">Playmobil</span><br></a>
                        </td>
                        <td>
                          <a href="detalle.html"><span style="color: rgb(133, 135, 150)">$279</span><br></a>
                        </td>
                        <td>
                          <div class="col">
                            <span id="quant-1"><a href="detalle.html">3</a></span>
                          </div>
                        </td>
                        <td>
                          <a href="detalle.html"><span style="color: rgb(133, 135, 150)">70142</span><br></a>
                        </td>
                        <td>
                          <div class="col d-flex align-middle justify-content-center">
                            <div class="row" style="margin: 0px !important">
                              <div class="col">
                                <div class="row">
                                  <div class="col">
                                    <a href="detalle.html"><span style="font-size: 100% !important">4008789701428</span></a>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col" style="padding: 3px !important">
                                    <a href="detalle.html"><img class="barcode-img" src="../assets/img/test-barcode.png"></a>
                                  </div>
                                </div>
                              </div>
                            </div>
                      ...
                      <tr id="article-row-2" class="align-middle articles-row">
                        <td class="article-icon">
                          <a href="detalle.html"><img class="mini-image" src="https://media.playmobil.com/i/playmobil/71162_product_detail/Polic%C3%ADa%20con%20Perro?locale=es-MX,es,en,*&amp;$pdp_product_main_xs$&amp;fmt=auto&amp;strip=true&amp;qlt=80&amp;fmt.jpeg.chroma=1,1,1&amp;unsharp=0,1,1,7&amp;fmt.jpeg.interlaced=true"></a>
                        </td>
                        <td>
                        ...
                        <td>
                          <div class="col">
                            <span id="quant-2"><a href="detalle.html">3</a></span>
                          </div>
                        </td>
                        <td>
                          <a href="detalle.html"><span style="color: rgb(133, 135, 150)">70142</span><br></a>
        ...
        <footer class="bg-white sticky-footer">
          <div class="container my-auto">
            <div class="text-center my-auto copyright">
              <span>Copyright © Castelán Carpinteyro 2023</span>
            </div>
          </div>
        </footer>
      </div>

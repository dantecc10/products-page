        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="text-dark mb-4 text-center main-branding-text-color fw-bold">Venta</h1>
                    <div class="row">
                        <div class="col col-12 col-xl-8" id="tabla-productos">
                            <div class="card shadow">
                                <div class="card-header py-3">
                                    <p class="text-primary m-0 fw-bold main-branding-text-color">Artículos en venta</p>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="input-group"><span class="input-group-text"><i class="fas fa-barcode main-branding-text-color"></i></span><input class="form-control" type="text" id="input-barcode" placeholder="Añadir producto" autofocus=""><button class="btn btn-primary main-branding-background-color" type="button"><i class="fas fa-plus-square"></i></button></div>
                                        </div>
                                    </div>
                                    <div class="table-responsive table mt-2 text-center" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                        <table class="table my-0 cell-text" id="dataTable">
                                            <thead>
                                                <tr>
                                                    <th class="align-middle col-lg-2">Imagen</th>
                                                    <th class="col-lg-5">Detalles</th>
                                                ...
                                                <tr id="article-row-1" class="align-middle articles-row">
                                                    ...
                                                    <td>
                                                        <div class="col" style="height: 100% !important;width: 90% !important;">
                                                            <div class="row">
                                                                <div class="col col-6 pe-0 d-flex align-items-center justify-content-end"><input type="number" class="quantity-input d-flex justify-content-center data-quantity" style="width: 100% !important;text-align: center !important;" value="1" max="3"><input type="number" class="d-flex justify-content-center data-stock visually-hidden" style="width: 100% !important;text-align: center !important;" value="3" max="3" min="3" disabled=""></div>
                        ...
                        <div class="col col-12 col-xl-4">
                            <div class="card shadow mt-3 mt-xl-0">
                                <div class="card-header py-3">
                                    <p class="text-primary m-0 fw-bold main-branding-text-color">Resumen</p>
                                </div>
                                <div class="card-body">
                                    <div class="col">
                                        <div class="row">
                                            <div class="col col-6 col-md-7 col-lg-8">
                                                <div class="row">
                                                    <div class="col d-flex justify-content-end"><span>Artículos</span></div>
                                                </div>
                                                <div class="row">
                                                    <div class="col d-flex justify-content-end"><span>Total</span></div>
                                                </div>
                                            </div>
                                            <div class="col col-6 col-md-5 col-lg-4">
                                                <div class="row">
                                                    <div class="col d-flex justify-content-start"><a href="#tabla-productos"><span id="total-articles-container">(5)<br></span></a></div>
                                                </div>
                                                <div class="row">
                                                    <div class="col"><span id="total-container" class="fw-bold">$850</span></div>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
    ...
    <optgroup label="Métodos de pago">
        ...
        <option value="3">Tarjeta - PayPal (cargos extra)</option>
                                ...
                                <div class="card-footer py-3">
                                    <p class="text-primary m-0 fw-bold main-branding-text-color">Venta</p>
                                </div>
                            </div>
                        </div>
                    </div>

...
if (isset($_SESSION['cart']) && sizeof($_SESSION['cart']['Products']) > 0) {
    ...
    for ($i = 0; $i < $n; $i++) {
        ...
        $outputHTML .= ('<td class="article-icon">
                        ...
                        <td>
                            <a href="details.php?product="' . $product_info[$i][0] . '">
                                <span class="data-name" style="color: rgb(133, 135, 150);">' . $product_info[$i][1] . '</span><br>
                            </a>
                                ...
                                <div class="row" style="margin: 0px !important;">
                                    <div class="col">
                                        <div class="row">
                                            <div class="col">
                                                <a href="details.php?product="' . $product_info[$i][0] . '">
                                                    <span class="data-barcode" style="font-size: 100% !important;">' . $product_info[$i][5] . '</span>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col" style="padding: 3px !important;">
                                                <a href="details.php?product="' . $product_info[$i][0] . '">
                                                    <img src="' . barcode_src_generator($generator, $product_info[$i][5]) . '" class="barcode-img">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col col-3" style="padding: 3px !important;">
                                                <a href="details.php?product="' . $product_info[$i][0] . '">
                                                    <span class="data-id" style="font-size: xx-small !important;">ID: ' . $product_info[$i][0] . '</span>
                                                </a>
                                            </div>
                        ...
                        <td>
                            <a href="details.php?product="' . $product_info[$i][0] . '" class="fs-5">
                                <span class="data-price" style="color: rgb(133, 135, 150);">$' . $product_info[$i][9] . '</span><br>
                            </a>
                        </td>
                        <td>
                            <div class="col">
                                <div class="row">
                                    <div class="col col-6 pe-0 d-flex align-items-center justify-content-end">
                                        <input type="number" class="d-flex justify-content-center data-quantity quantity-input" style="width: 100% !important; text-align: center !important;" value="' . $_SESSION['cart']['Products'][$i]['quantity'] . '" max="' . $product_info[$i][8] . '" onchange="javascript:calculate_totals();"/>
                                        <input type="number" class="d-flex justify-content-center data-stock visually-hidden" style="width: 100% !important; text-align: center !important;" value="' . $product_info[$i][8] . '" max="' . $product_info[$i][8] . '" min="' . $product_info[$i][8] . '" disabled/>
                                    </div>
                        ...
                        <td>
                            <span class="fw-bold fs-5 subtotal-container">$' . $product_info[$i][9] . '</span>
                        </td>');

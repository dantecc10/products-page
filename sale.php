...
<head>
    ...
    <title>Venta - CC Comercial</title>
                        ...
                        <div class="col col-12 col-xl-8" id="tabla-productos">
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="input-group"><span class="input-group-text"><i class="fas fa-barcode main-branding-text-color"></i></span><input class="form-control" type="text" id="input-barcode" placeholder="Añadir producto" autofocus="" onchange="javascript:add_article();"><button class="btn btn-primary main-branding-background-color" type="button" onclick="add_article();"><i class="fas fa-plus-square"></i></button></div>
                                        </div>
                                    </div>

                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <!--<form>-->
                                        <div class="input-group"><input class="form-control" id="filtering_input" type="text" placeholder="Buscar" onchange="javascript:table_filter();"><button class="btn btn-primary main-branding-background-color" type="button"><i class="fas fa-search"></i></button></div>
                                    <!--</form>-->
                                </div>
                            </div>
